...
const ProductCard = ({product}) => {
    ...
    return product && (
        <div className="border border-gray-500/20 rounded-md px-3 md:px-4 py-2 bg-white w-full transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg">
